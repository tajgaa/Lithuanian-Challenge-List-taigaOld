export function score(rank){
  ...
  if (rank >= 1){
    if(rank < 11){
      return RoundPoints(149.61*(1.137^(1-rank))+100.39);
    }
    else if(rank > 10 & rank <= 35){
      return RoundPoints(166.611*(1.0099685^(17-rank))-31.152);
    }
    else if (rank > 35 & rank <= 55){
      return RoundPoints(212.61*(1.036^(14-rank))+6.071);
    }
    else if (rank > 55 & rank <= 75){
      return RoundPoints(56.191*(2^((78.147-(rank+3.2))((Math.log(50)/99))))-41.10949);
    }
    else return 0;
}
 ...
 */
export function RoundPoints(num)
{
